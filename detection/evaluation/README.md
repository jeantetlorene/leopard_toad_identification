...
- **[`binary_eval_test_pool_wlt.py`](pipelines/binary_eval_test_pool_wlt.py)**: Dedicated script for WLT-focused image-level evaluation across all model and cycle combinations on the test unlabeled pool.
