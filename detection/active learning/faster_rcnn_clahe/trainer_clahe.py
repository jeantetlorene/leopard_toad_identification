...
from dataset_clahe import YoloToFasterRCNNDatasetCLAHE, collate_fn, EarlyStopping
...
def _train_routine(model, run_name, dataset_dir, epochs=100, patience=25):
    ...
    train_loader = DataLoader(
        YoloToFasterRCNNDatasetCLAHE(
            dataset_dir, "train", img_size=IMG_SIZE, augment=True
        ),
