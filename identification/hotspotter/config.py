...
CROSS_TUNNEL_MATCHES_CSV = os.path.join(IDENTIFICATION_DIR, "cross_tunnel_matches.csv")
ALL_MATCHES_CSV = os.path.join(IDENTIFICATION_DIR, "possible_matches.csv")

# Crop directory paths
CROPS_DIR = os.path.join(IDENTIFICATION_DIR, "data", "wlt_predictions_crops")
LEGACY_CROPS_DIR = os.path.join(BASE_DIR, "dataset", "dataset_reid_crops")

# SIFT Parameters optimized for toad patterns
SIFT_CONTRAST_THRESHOLD = 0.02  # Captures low-contrast spots (default 0.04)
SIFT_EDGE_THRESHOLD = 15  # Retains keypoints along spot edges (default 10)
...
SHARPEN_KERNEL = (9, 9)  # Unsharp mask Gaussian kernel size
